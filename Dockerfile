...
COPY . /home/node/.n8n/custom/nodes

# Copiar y ejecutar el script de enlace
COPY ./nodes-link.sh /home/node/.n8n/custom/nodes/nodes-link.sh
RUN chmod +x /home/node/.n8n/custom/nodes/nodes-link.sh

# Debug: Mostrar estructura antes de ejecutar
RUN tree /home/node

# Ejecutar script
RUN /home/node/.n8n/custom/nodes/nodes-link.sh
